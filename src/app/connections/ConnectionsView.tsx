        ...
        <div style={{ padding: '24px 0 0' }}>
          ...
          {activeTab === 'あいさつ' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              ...
              {/* Received Event Invitations Section */}
              {eventInvitations.length > 0 && (
                <section style={{ padding: '0 8px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                    ...
                    <div>
                      <h2 style={{ fontSize: '17px', fontWeight: 600, margin: 0, color: '#333' }}>イベントの招待</h2>
                      <p style={{ fontSize: '12px', color: '#666', margin: '2px 0 0 0' }}>届いている同行のお誘い</p>
                    </div>
                  </div>
                      ...
                      <div key={invite.invitation_id} style={{
                        ...
                        <div style={{ width: '56px', height: '56px', borderRadius: '50%', overflow: 'hidden', marginBottom: '8px' }}>
                          {invite.sender_avatar_url ? (
                            <img src={invite.sender_avatar_url} alt={invite.sender_nickname} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                          ) : (
                        ...
                        <div style={{ fontSize: '15px', fontWeight: 600, marginBottom: '8px', textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', width: '100%' }}>{invite.sender_nickname}さん</div>

                        <div style={{ fontSize: '12px', color: '#666', marginBottom: '16px', textAlign: 'center', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                          {invite.event_title}
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '8px', width: '100%' }}>
                          <button 
                            ...
                            style={{ flex: 1, padding: '8px', border: 'none', borderRadius: '8px', background: '#000', color: '#fff', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
                          >
                            承認
                          </button>
                          <button 
                            ...
                            style={{ flex: 1, padding: '8px', border: 'none', borderRadius: '8px', background: '#f3f4f6', color: '#374151', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
                          >
                            お断り
                          </button>
                        </div>
